	...
	<section id="descricao" class="sobre-desc detalhes-cerv">
		<div class="container">
			...
			<div class="col-md-10 text-left wow fadeIn">
				<h1>IPA</h1>
				<p>IPA ou Indian Pale Ale é uma cerveja rubra, frutada e encorpada, com alto grau de 
amargor. Sua receita inclui uma levedura que torna seu sabor apimentado e marcante.</p>
				<p><strong>Ingredientes:</strong><br>
Malte selecionado, água, lúpulos de aroma, lúpulos de amargor e leveduras.</p>
				<p><strong>Dados técnicos:</strong><br>
Álcool (ABV) 5%; Cor (SRM) 18; Amargor (IBU) 40; OG 1,63; FG 1,012.</p>
